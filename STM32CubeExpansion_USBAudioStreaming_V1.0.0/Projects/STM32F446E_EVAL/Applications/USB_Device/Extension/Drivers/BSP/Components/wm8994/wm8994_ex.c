  ...
  *          It is extended  from [wm8994.c, version V2.1.0].
  *          modified functions : 
  *                                - wm8994_Init: 
  *                                - wm8994_Init_ext added  to support 24/16bit
  *                                
  ******************************************************************************
  * @attention
  *
...
AUDIO_DrvTypeExtDef wm8994_drv= 
{
  wm8994_InitExt,
  wm8994_DeInit,
  wm8994_ReadID,
...
uint32_t wm8994_Init(uint16_t DeviceAddr, uint16_t OutputInputDevice, uint8_t Volume, uint32_t AudioFreq)
{
  ...
  return wm8994_InitExt(DeviceAddr, OutputInputDevice, Volume, AudioFreq , 16  );
}
 /**
  * @brief Initializes the audio codec and the control interface.
  * @param DeviceAddr: Device address on communication Bus.   
  ...
  * @param Volume: Initial volume level (from 0 (Mute) to 100 (Max))
  * @param AudioFreq: Audio Frequency
  * @param res_byte : audio bit depth :  2 for 16 bit and 3 for 24 bit
  * @retval 0 if correct communication, else wrong communication
  */
 uint32_t wm8994_InitExt(uint16_t DeviceAddr, uint16_t OutputInputDevice,
                                uint8_t Volume,uint32_t AudioFreq, uint8_t AudioRes)
{
  uint32_t counter = 0;
  ...
  else
  {
	  ...
	  else/*(AudioRes == 24 ) */
	  {
		...
		//counter += CODEC_IO_Write(DeviceAddr, 0x300, 0x4050);
	  }
  }
