...
/** @defgroup WM8994_Exported_Types
  ...
  */
   typedef struct
{
  uint32_t  (*Init)(uint16_t, uint16_t, uint8_t, uint32_t,uint8_t);
  void      (*DeInit)(void);
...
uint32_t wm8994_InitExt(uint16_t DeviceAddr, uint16_t OutputInputDevice, uint8_t Volume, uint32_t AudioFreq, uint8_t AudioRes);
/* AUDIO IO functions */
...
extern AUDIO_DrvTypeExtDef   wm8994_drv;
